...
// 2019/10/12 supports also SSD1306 (charge pump enable)
//
...
var OledDisplay = function(i2cPort,slaveAddress){
  ...
  if ( slaveAddress ){
    ...
    this.slaveAddress = OLED_CONST.address;
  }
  this.i2cSlave = null;
...
OledDisplay.prototype = {
  initQ: function(){
    ...
    if ( this.useSSD1306 ){
      console.log("SSD1306 charge pump enable");
      this.registerQueue(OLED_CONST.commandMode,0x8d); //charge pump enable
      this.registerQueue(OLED_CONST.commandMode,0x14); //charge pump ON
    }
  },
